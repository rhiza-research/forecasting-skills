---
name: plot-compare
description: Render a side-by-side multi-panel comparison PNG of two weather-skills standard dataset stores (gridded-vs-gridded or station-vs-gridded). Use for sat-vs-station validation, model-vs-obs comparison, or cross-source QC.
license: MIT
