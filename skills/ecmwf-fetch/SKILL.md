...
- A task asks for an ECMWF S2S forecast for a specific init date (real-time inits are embargoed for 2 days).
...
```bash
# Continental Africa (custom bbox — not a country lookup)
